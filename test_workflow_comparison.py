...
def run_comparison():
    ...
    combinations = [
        ...
        # ======================
        # 5. YOLOv8m (Detect) + SAM2 (Segment) + ByteTrack
        {
            "name": "YOLOv8m_SAM2_ByteTrack",
            "det_model": "yolo",
            "det_path": "models/yolov8m_det_best.pt",
            "seg_model": "sam2",
            "seg_path": "models/sam2_b.pt",
        ...
        # ======================
        # 6. YOLOv8m (Detect) + SAM2 (Segment) + FeatureHomography (SIFT/SuperPoint)
        {
        ...
        # 7. YOLOv8m (Detect) + SAM2 (Segment) + ECC Homography (Sub-pixel refinement)
        {
        ...
        # 8. YOLOv8m (Detect) + SAM2 (Segment) + SAM2 Memory (FIFO + DAM)
        {
            "name": "YOLOv8m_SAM2_SAM2Memory",
            "det_model": "yolo",    
            "det_path": "models/yolov8m_det_best.pt",
            "seg_model": "sam2",
            "seg_path": "models/sam2_b.pt",
        ...
        # 9. YOLOv8m (Detect) + SAM2 (Segment) + Hybrid Flow (GFTT + FB error)
        {
